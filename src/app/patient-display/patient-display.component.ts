  ...
  ngOnInit(): void {
    this.apollo.watchQuery({
      ...
      if (res.data.patient?.nonbinary){
        this.patientGender = "transgender"
      }
      ...
      if(this.patient?.age != null){this.patientBasicInformation?.push(this.patient?.age + ' years old')}
      ...
      if(this.patient?.estimated_body_weight != null){this.patientBasicInformation?.push(this.patient?.estimated_body_weight + ' kg')}
      if(this.patient?.bmi != null){this.patientBasicInformation?.push('BMI of ' + this.patient?.bmi)}
      if(this.patient?.size_cm != null){this.patientBasicInformation?.push(this.patient?.size_cm + ' cm')}
      if(this.patient?.gcs_summary != null){this.patientBasicInformation?.push(this.patient?.gcs_summary)}
    });
  }
